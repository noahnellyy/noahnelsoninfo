    ...
    <div className={styles.container}>
      ...
      <div className={styles.main1}>
        ...
        <p>Hi! I&apos;m Noah &#x1F44B;</p>
          ...
          <a href="https://www.grindr.com/" className={styles.riis}><em> Grindr LLC</em></a>, during my time there I was actively working with and uploading code in production. I modernized the analytics infrastructure by integrating a deprecated analytics class with the current version, ensuring alignment with the MVI coding architecture and optimizing it through my understanding of dependency injection. Additionally, I led a significant project involving in-depth research, a complete redesign, and diligent testing to introduce a robust circuit breaker mechanism to enhance our application&apos;s dependability.</p>
