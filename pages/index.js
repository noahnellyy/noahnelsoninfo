    ...
    <div className={styles.container}>
      ...
      <div className={styles.main1}>
        ...
        <p>Hi! I&apos;m Noah &#x1F44B;</p>
          ...
          <p className={styles.maintext}>Before Grindr, during the summer of &apos;22, I previously worked as a <strong>Software Engineer Intern</strong> at <a href="https://riis.com/" className={styles.riis}><em>RIIS LLC</em></a>, where I developed applications specific to commerical drones!</p>
